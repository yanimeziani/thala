  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-ink transition-colors duration-500">
      ...
      <div className="relative flex h-screen w-full flex-col overflow-hidden">
        <header className="pointer-events-auto absolute left-0 right-0 top-0 z-20 flex items-center justify-between px-6 pb-4 pt-8 sm:px-10 lg:px-16 xl:px-24">
        ...
        <div className="relative z-10 flex h-full flex-1 overflow-hidden">
          <div className="scrollbar-none flex h-full w-full snap-x snap-mandatory overflow-x-auto">
            <section className="flex h-full w-screen shrink-0 snap-start flex-col px-6 pb-16 pt-32 sm:px-10 lg:px-16 xl:px-24">
              <main className="relative flex h-full w-full flex-1 flex-col items-center gap-12 text-center transition-colors duration-500 lg:flex-row lg:items-start lg:text-left">
            ...
            <section className="relative z-10 flex h-full w-screen shrink-0 snap-start flex-col justify-center px-6 py-24 sm:px-10 lg:px-16 xl:px-24">
              <div className="grid gap-6 rounded-[36px] border border-strong bg-elevated p-8 shadow-card transition-colors duration-500 lg:grid-cols-3">
                {highlights.map((item) => (
                  <div
                    key={item.title}
            ...
            <section className="relative z-10 flex h-full w-screen shrink-0 snap-start flex-col justify-center px-6 py-24 sm:px-10 lg:px-16 xl:px-24">
              ...
              <div className="relative mt-10">
                ...
                <div className="scrollbar-none flex gap-6 overflow-x-auto px-2 pb-6 pt-1 sm:px-6 snap-x snap-mandatory">
